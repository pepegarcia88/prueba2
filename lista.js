...
function agregarTarea(){
    ...
    botonCerrar.setAttribute("onclick", "eliminarTarea(this), resumenTareas(), guardarEnLocal()");
...
function eliminarTarea(nodo){
   var elementoLista = nodo.parentElement;
...
function comprobarCheck(check){
    ...
    var elementoLista = check.parentElement;
    elementoLista.setAttribute("class", "listaCheckeada");
    var botonCerrar = elementoLista.querySelector('.botonCerrar');
    if (checkeado){    
